...
from quantum_circuit_simplifier.model import QuantumGraph, GraphNode, EdgeName
...
def test_remove_duplicate_hadamards_1():
    ...
    expected_graph.add_node(GraphNode("i", (0, 0)))
    expected_graph.add_node(GraphNode("i", (0, 1)))
