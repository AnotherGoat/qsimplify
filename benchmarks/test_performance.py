...
from qsimplify.model.quantum_gate import CxGate, HGate, SGate, TGate
...
def process_and_simplify(gates, benchmark_fixture=None):
    ...
    if thread.is_alive():
        ...
        if benchmark_fixture:
            ...
            benchmark_fixture.extra_info["diagnostico"] = (
                "FALLO: Excedió el tiempo máximo aceptable de 5 minutos."
            )
        return "TIMEOUT"
